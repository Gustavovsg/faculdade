...
class lanchonete:
    """
    Classe principal do sistema da lanchonete.
    ...
    def mostrar_menu_principal(self) -> None:
        """
        Exibe o menu principal da lanchonete.
        Complexidade de tempo: O(1)
        """
        print("\n" + "="*50)
        print(f"{'lanchonete DO SEU ZÉ':^50}")
        print("="*50)
    ...
    def mostrar_cardapio(self) -> None:
        """
        Exibe o cardápio completo da lanchonete.
        ...
        while True:
            ...
            try:
                ...
                if opcao == '1':
                    ...
                    print("\nObrigado por usar o sistema da lanchonete do Seu Zé!")
                    print("Volte sempre!\n")
                    break
                else:
